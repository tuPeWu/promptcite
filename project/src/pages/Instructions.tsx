      ...
      <div className="prose prose-lg space-y-6">
        <section>
          <h2 className="text-2xl font-semibold mb-4">
            {t('instructions.gettingStarted.heading')}
          </h2>
          <ol className="list-decimal pl-6 space-y-4">
            {t('instructions.gettingStarted.steps', { returnObjects: true }).map(
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-4">
            {t('instructions.usingCitation.items', { returnObjects: true }).map(
        ...
        <section>
          ...
          <pre className="bg-gray-50 p-4 rounded-md">{t('instructions.format.example')}</pre>
        </section>
      </div>
    </div>
  );
